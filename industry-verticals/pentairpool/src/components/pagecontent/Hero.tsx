...
/* PentairPool variant — full-bleed water overlay, centered white type */
export const PentairPool = (props: AppPromoProps): JSX.Element => {
  ...
  return (
    <div className={`component hero pentair-pool ${sxaStyles}`} id={id ? id : undefined}>
      <picture>
        <NextImage field={props.fields.Image} className="" width={1920} height={640}></NextImage>
      </picture>
