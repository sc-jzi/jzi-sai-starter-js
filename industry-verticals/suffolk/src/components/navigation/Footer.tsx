...
/* Suffolk variant — navy mega footer */
export const Suffolk = (props: FooterProps): JSX.Element => {
  const id = props.params.RenderingIdentifier;
  const sxaStyles = `${props.params?.styles || ''}`;

  return (
    <div className={`component component-spaced footer suffolk ${sxaStyles}`} id={id ? id : undefined}>
