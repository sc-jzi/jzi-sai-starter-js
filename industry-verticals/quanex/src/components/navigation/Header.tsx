...
/* Quanex variant — deep green header bar */
export const Quanex = (props: HeaderProps): JSX.Element => {
  const id = props.params.RenderingIdentifier;
  const { page } = useSitecore();

  return (
    <div className={`component header quanex ${props.params.styles?.trimEnd()}`} id={id ? id : undefined}>
