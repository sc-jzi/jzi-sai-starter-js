...
/* Quanex variant — dark green corporate footer */
export const Quanex = (props: FooterProps): JSX.Element => {
  const id = props.params.RenderingIdentifier;
  const sxaStyles = `${props.params?.styles || ''}`;

  return (
    <div className={`component component-spaced footer quanex ${sxaStyles}`} id={id ? id : undefined}>
            ...
            <div className="col">
              ...
              <div className="social-links d-flex gap-3">
                <Link field={props.fields.SocialLink1}>
                  <NextImage field={props.fields.SocialIcon1} width={24} height={24} />
                </Link>
                <Link field={props.fields.SocialLink2}>
                  <NextImage field={props.fields.SocialIcon2} width={24} height={24} />
                </Link>
                <Link field={props.fields.SocialLink3}>
                  <NextImage field={props.fields.SocialIcon3} width={24} height={24} />
                </Link>
              </div>
              {(props.fields?.Link1?.value?.href || props.fields?.Link2?.value?.href) && (
                <div className="mt-4">
                  <Link field={props.fields.Link1} className="button button-main me-3" />
                  <Link field={props.fields.Link2} className="button button-simple" />
                </div>
              )}
            </div>
          </div>
          <div className="copyright mt-5 pt-4 border-top border-light-subtle">
