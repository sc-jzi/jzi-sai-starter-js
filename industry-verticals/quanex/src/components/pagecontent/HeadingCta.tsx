...
/* Quanex variant — centered value proposition intro */
export const Quanex = (props: HeadingCtaProps): JSX.Element => {
  ...
  return (
    <div className={`component heading-cta quanex ${sxaStyles}`} id={id ? id : undefined}>
      <div className="container">
        <div className="heading-content-wrapper">
          {(isPageEditing || props.fields?.Eyebrow?.value) && (
            <h6 className="quanex-eyebrow">
              <Text field={props.fields?.Eyebrow} />
            </h6>
          )}
          <h2 className="quanex-heading">
            <Text field={props.fields?.Heading} />
          </h2>
          <p className="quanex-body">
            <Text field={props.fields?.Text} />
          </p>
          {(isPageEditing || props.fields?.Link?.value?.href) && (
            <Link field={props.fields.Link} className="button button-main mt-4" />
          )}
        </div>
      </div>
    </div>
