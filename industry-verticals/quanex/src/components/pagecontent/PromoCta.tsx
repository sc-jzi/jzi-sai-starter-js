...
/* Quanex variant — careers call-to-action with green panel */
export const QuanexCareers = (props: PromoCtaProps): JSX.Element => {
  ...
  return (
    <div className={`component promo-cta quanex-careers ${sxaStyles}`} id={id ? id : undefined}>
      <div className="container-fluid px-0">
        <div className="row g-0 main-content">
          ...
          <div className="col-lg-7">
            <NextImage field={props.fields.Image} width={1200} height={600} className="w-100 h-100 object-fit-cover" />
          </div>
        </div>
      </div>
    </div>
...
/* Quanex variant — hardware solutions overlay promo */
export const QuanexHardware = (props: PromoCtaProps): JSX.Element => {
  const id = props.params.RenderingIdentifier;
  const { page } = useSitecore();
  const isPageEditing = page.mode.isEditing;
  const sxaStyles = `${props.params?.styles || ''}`;
  ...
  return (
    <div className={`component promo-cta quanex-hardware ${sxaStyles}`} id={id ? id : undefined}>
      <NextImage field={props.fields.Image} width={1920} height={600} className="position-absolute w-100 h-100 object-fit-cover" />
