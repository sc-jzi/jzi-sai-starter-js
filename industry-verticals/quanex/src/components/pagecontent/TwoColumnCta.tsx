...
/* Quanex variant — innovation section layout */
export const Quanex = (props: TwoColumnCtaProps): JSX.Element => {
  ...
  return (
    <div className={`component two-column-cta quanex ${sxaStyles}`} id={id ? id : undefined}>
      <div className="container">
        <div className="row align-items-center row-gap-4">
          <div className="col-lg-6">
            <h6 className="eyebrow-accent text-uppercase">Innovation</h6>
            <h2 className="title">
            ...
            {(isPageEditing || props.fields?.Link1?.value?.href) && (
              <Link field={props.fields.Link1} className="button button-main mt-3" />
            )}
          </div>
          <div className="col-lg-6">
            <NextImage field={props.fields.Image2} width={800} height={500} className="img-fluid" />
          </div>
        </div>
      </div>
    </div>
