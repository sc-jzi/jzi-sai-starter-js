...
/* Quanex variant — solutions grid with section heading */
export const Quanex = (props: ThreeColumnCtaProps): JSX.Element => {
  ...
  return (
    <div
      className={`component component-spaced three-column-cta quanex ${sxaStyles}`}
      id={id ? id : undefined}
    >
      <div className="container">
        <div className="section-heading">
          <h2>Solutions That Power What&apos;s Next</h2>
        </div>
