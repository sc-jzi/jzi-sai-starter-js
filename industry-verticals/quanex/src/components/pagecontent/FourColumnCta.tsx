...
/* Quanex variant — news and featured content cards */
export const Quanex = (props: FourColumnCtaProps): JSX.Element => {
    ...
    return (
      ...
      >
        <div className="content-wrapper">
          <NextImage field={image} width={300} height={220} />
          <div className="text-wrapper">
            ...
            {(isPageEditing || link?.value?.href) && <Link field={link} />}
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div
      className={`component component-spaced four-column-cta quanex-news ${sxaStyles}`}
      id={id ? id : undefined}
    >
